...
/**
 * 里氏替换原则，将依赖替换为其他的基于同一基类的实现
 */
// interface PersistanceServiceInterface {
//     save(entity: any): number
// }

// class CookiePersitanceSerice implements PersistanceServiceInterface {
//     save(entity: any): number {
...
//     public saveAsFavourite(articledId: number) {
//         return this._persistanceService.save(articledId)
//     }
// }


// const favController = new FavouritesController(new CookiePersitanceSerice())
...
// const favh5Controller = new FavouritesController(new LocalStoragePersitanceService())
